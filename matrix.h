...
#define MATRIX_GET(matrix, T, x, y) (T)((T*)matrix->elements)[matrix->w * y + x]
...
// iterate across each eleement of matrix and call some function passed to the
// macro fn signature should look like void some_fn(Matrix* m, size_t index, T*
// element);
//
// note this is called _MAP but really it is just an iterator helper and doesn't
// create a new matrix or modify the original unless specified in the provided
// fn
...
// get # elements
size_t matrix_element_len(Matrix* matrix) { return matrix->w * matrix->h; }
