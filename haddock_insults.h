...
// originally gathered many years ago in a ruby script here:
// https://github.com/granolocks/haddock-insult-generator
...
const size_t haddock_insult_count =
    sizeof(haddock_insults) / sizeof(haddock_insults[0]);
